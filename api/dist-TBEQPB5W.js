    ...
    transform: {
      ...
      async handler(code, id) {
        ...
        try {
          ...
          const traverseModule = await import("./lib-PZULBIES.js");
          const traverse = ((_a = traverseModule.default) == null ? void 0 : _a.default) || traverseModule.default || traverseModule;
          ...
          traverse(ast, {
            ...
            JSXOpeningElement(elementPath) {
              ...
              if (currentElement) {
                const { line = 0, column: col = 0 } = ((_a2 = jsxNode.loc) == null ? void 0 : _a2.start) ?? {};
